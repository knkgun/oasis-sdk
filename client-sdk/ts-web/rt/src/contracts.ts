...
export class Wrapper extends wrapper.Base {
    ...
    callUpload() { return this.call<types.ContractsUpload, types.ContractsUploadResult>(METHOD_UPLOAD); }
    callInstantiate() { return this.call<types.ContractsInstantiate, types.ContractsInstantiateResult>(METHOD_INSTANTIATE); }
    callCall() { return this.call<types.ContractsCall, types.ContractsCallResult>(METHOD_CALL); }
    callUpgrade() { return this.call<types.ContractsUpgrade, void>(METHOD_UPGRADE); }
    queryCode() { return this.query<types.ContractsCodeQuery, types.ContractsCode>(METHOD_CODE); }
    queryInstance() { return this.query<types.ContractsInstanceQuery, types.ContractsInstance>(METHOD_INSTANCE); }
    queryInstanceStorage() { return this.query<types.ContractsInstanceStorageQuery, types.ContractsInstanceStorageQueryResult>(METHOD_INSTANCE_STORAGE); }
    queryPublicKey() { return this.query<types.ContractsPublicKeyQuery, types.ContractsPublicKeyQueryResult>(METHOD_PUBLIC_KEY); }
    queryCustom() { return this.query<types.ContractsCustomQuery, types.ContractsCustomQueryResult>(METHOD_CUSTOM); }
}
